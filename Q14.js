...
let guestArr = ["Zoya", "Sheeza", "Hiban", "Husain"];
guestArr.map((item) => (console.log(`Dear ${item}, you are cordially invited to dinner at my place. Looking forward to your presence!`)));
